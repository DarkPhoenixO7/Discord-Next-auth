...
import { Edit, FileIcon, FileKey, ShieldAlert, ShieldCheck, Trash } from "lucide-react";
      ...
      <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
         <div className="group flex items-start gap-x-2 w-full">
            <div onClick={onMemberClick} className="cursor-pointer hover:drop-shadow-md transition">
                <UserAvatar src={member.profile.imageUrl? member.profile.imageUrl: ""} />
            </div>
            <div className="flex flex-col w-full">
                ...
                {isPdf &&(
                    <div className="relative flex items-center p-2 mt-2 rounded-md and bg-background/10">
            ...
            p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border rounded-sm">
               {canEditMessage &&(
                <ActionTooltip label="Edit">
                   <Edit onClick={()=> setIsEditing(true)} className="cursor-pointer ml-auto h-4 w-4 text-zinc-500
